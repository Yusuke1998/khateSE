	...
	<div class="row">
		...
		<div class="col-md-9 col-sm-12 animated zoomInRight slow">
			...
			@if($contentsm == '[]' && $contents == '[]')
				<h3 class="text-center mb-5">No hay contenido asociado a este tema.</h3>
				<p class="text-center">
				...
				@if(count($contents) >= 1)
					<div class="card-body px-5">
						<p class="text-center">Contenido textual</p>
							<h2 class="animated rollIn delay-1s font-weight-light">{{ $contents[0]->topic->topic }}</h2>
							<ul class="list-group">
								@foreach( $contents as $c )
								<p class="animated rollIn delay-1s">SECCIÓN {{ $c->section->section }}</p>
